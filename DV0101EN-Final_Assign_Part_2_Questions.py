...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",
             style={'textAlign':'center', 'çolor':'#503D36', 'font-size':24}),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        df = recession_data.groupby(["Vehivle_Type", "unemployment_rate"])["Automobile_Sales"].mean().reset_undex()
        R_chart4 = dcc.Graph(figure=px.bar(df, x="unemployment_rate", y="Automobile_Sales", color="unemployment_rate",
